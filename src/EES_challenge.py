...
if __name__ == '__main__':
    ...
    train_generator = ChunksGenerator_preprocessing(sequence_max_length=sequence_max_length, window_length=window_length,
                                          data=train_data,
                                          ...
                                          precutting=False, precutting_window_size=None, precutting_window_step=None)
    ...
    devel_generator = ChunksGenerator_preprocessing(sequence_max_length=sequence_max_length, window_length=window_length,
                                          data=val_data,
                                          data_preprocessing_mode=data_preprocessing_mode,num_mfcc=num_mfcc,
